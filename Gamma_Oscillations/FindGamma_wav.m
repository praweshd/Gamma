function [ripples] = FindGamma_wav(filtered,varargin)

%FindGamma_wav - wavelet based gamma oscillation detection
%
%  USAGE
%
...
restrict = [];
sd = [];
lowThresholdFactor = -0.1; % Ripple envoloppe must exceed lowThresholdFactor*stdev
highThresholdFactor = 0; % Ripple peak must exceed highThresholdFactor*stdev
